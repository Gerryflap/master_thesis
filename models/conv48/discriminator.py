...
class Discriminator48(torch.nn.Module):
    def __init__(self, h_size, use_bn=False, use_mish=False, n_channels=1, dropout=0.0, use_logits=True):
        ...
        self.conv_4 = torch.nn.Conv2d(h_size * 2, h_size * 4, kernel_size=4, stride=2)
...
if __name__ == "__main__":
    D = Discriminator48(4, n_channels=3)
    D(torch.rand((1, 3, 48, 48)))