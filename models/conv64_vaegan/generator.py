...
class VAEGANGenerator64(torch.nn.Module):
    def __init__(self, latent_size, h_size, bias=True, n_channels=1):
        ...
        self.conv_1 = torch.nn.ConvTranspose2d(self.latent_size, self.h_size * 4, 8, bias=self.bias)
        self.conv_2 = torch.nn.ConvTranspose2d(self.h_size * 4, self.h_size * 4, kernel_size=5, stride=2, bias=self.bias, padding=2, output_padding=1)
