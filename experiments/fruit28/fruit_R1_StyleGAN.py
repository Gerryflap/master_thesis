...
output_path = util.output.init_experiment_output_dir("fruit28", "r1_stylegan", args)
...
G = StyleGenerator(args.l_size, args.h_size, 7, 2, mapping_depth=4)
D = DeepDiscriminator(args.h_size, 28, 2, bn=False, lrn=False)
...
if args.train_enc:
    E = DeepEncoder(args.l_size, args.h_size, 28, 2, lrn=True)
