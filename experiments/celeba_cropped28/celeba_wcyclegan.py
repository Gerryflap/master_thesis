...
output_path = util.output.init_experiment_output_dir("celeba28", "WCycleGAN", args)
...
Gz = Encoder28(args.l_size, args.h_size, args.use_mish, n_channels=3, cap_variance=True, deterministic=False)
