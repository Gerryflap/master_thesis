...
output_path = util.output.init_experiment_output_dir("celeba28", "MorGAN_DD", args)
...
Gx = Generator28(args.l_size, args.h_size, args.use_mish, bias=False, n_channels=3, sigmoid_out=True)
Gz = Encoder28(args.l_size, args.h_size, args.use_mish, n_channels=3)

Dx = Discriminator28(args.h_size, use_bn=True, use_mish=args.use_mish, n_channels=3, dropout=args.dropout_rate, use_logits=True)
