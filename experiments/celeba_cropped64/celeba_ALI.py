...
parser.add_argument("--batch_size", action="store", type=int, default=100, help="Changes the batch size, default is 64")
...
Gx = Generator64(args.l_size, args.h_size, args.use_mish, n_channels=3, sigmoid_out=False)
